...
def vista_escanear_libro():
    ...
    st.markdown(
        ...
        <div style='text-align:center; margin-top:1rem;'>
            ...
            <p style='color:#9ca3af; font-size:0.9rem; margin:0;'>
                Captura la portada y deja que la IA intente identificar el libro automáticamente.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div>
            <p class='scan-subtitle'>
                1️⃣ Toma una foto clara de la portada &nbsp;·&nbsp;
                2️⃣ La IA intenta identificar título / autor / ISBN &nbsp;·&nbsp;
                3️⃣ Completa y guarda los datos
            </p>
        </div>
    ...
    if st.session_state.scan_data:
        ...
        if d.get("portada"):
            st.markdown("<h4 style='color:#22c55e;'>📕 Portada obtenida de Google Books</h4>", unsafe_allow_html=True)
            st.image(d["portada"], use_container_width=True)
